...
const LoginPage = () => {
  return (
    <div className="min-h-screen bg-white flex font-monstera flex-col w-full items-center justify-center p-4">
      <Navbar/>
      <div className="w-full max-w-[550px] space-y-5 h-screen ">
        ...
        <div className="space-y-4 w-full">
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="w-full bg-white text-white font-medium py-3 px-4 rounded-md flex items-center justify-center space-x-2 hover:bg-gray-100 transition duration-300">
