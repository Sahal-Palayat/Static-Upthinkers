  ...
  return (
    <div className=" px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1
          style={gradientStyle}
          className="text-4xl sm:text-5xl font-bold max-w-7xl mx-auto text-center relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-black dark:to-black"
        >
          Why trust us?
        </h1>
        ...
        <div className="space-y-16 text-[#A3A3A3]">
          ...
          />
          <div className="bg-gradient-to-r from-gray-500 to-white mt-8 w-full h-[1px]" />
          <Section
