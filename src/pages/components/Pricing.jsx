...
const Pricing = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="h-[500px] flex flex-col items-center justify-center text-white p-4 md:p-6 lg:p-8">
        <div className="inline-block mb-8 p-[4px] bg-[#2B2B2B] rounded-lg">
          <div className="p-1 bg-white rounded-md shadow-2xl shadow-[#06B6D4]">
            <HiClipboardList className="bg-white text-[#06B6D4] p-3 w-12 h-12 md:w-13 md:h-13 flex-shrink-0" />
          </div>
        </div>
        <h1
          style={gradientStyle}
        ...
        <div className="flex items-center space-x-2">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            />
            <div className="w-9 h-5 border bg-white peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-transparent rounded-full peer dark:bg-white border-gray-600 peer-checked:bg-white transition-all"></div>
      ...
      <div className="w-full bg-white text-[#A3A3A3] p-6 md:p-8 lg:p-10">
            ...
            {tiers.map((tier, index) => (
              <div
                ...
                className={`rounded-lg p-4 md:p-6 lg:p-8 flex flex-col justify-between ${
                  tier.highlighted
                    ? "h-full relative overflow-hidden bg-gradient-to-b from-[#151515] to-white"
