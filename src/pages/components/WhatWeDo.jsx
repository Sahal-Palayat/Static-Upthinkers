...
export default function WhatWeDo() {
  ...
  return (
    <section className="relative py-12 bg-gradient-to-b from-white/20  to-white/20 backdrop-blur-sm rounded-[40px] sm:rounded-[60px] transition-colors duration-300 mx-4 sm:mx-6 lg:mx-10">
