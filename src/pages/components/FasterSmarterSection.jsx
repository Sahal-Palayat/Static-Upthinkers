      ...
      <div className="w-full max-w-7xl space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="border border-gray-800 p-2 sm:p-4 rounded-xl shadow-lg w-full max-w-full">
            ...
            <div className="relative bg-gradient-to-bl from-white to-transparent -mt-2 sm:-mt-4 p-3 sm:p-4 rounded-lg overflow-hidden h-32 sm:h-40">
              <div
              ...
              >
                <Command
                  className="text-white p-[8px] sm:p-[10px] h-[36px] sm:h-[48px] w-[36px] sm:w-[48px] rounded-lg bg-gradient-to-t from-gray-800 to-white"
