    ...
    <div className="bg-white text-white h-[200px] items-center p-8 md:p-16">
      <div className="w-full  max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="lg:ml-8 flex justify-center lg:justify-end">
          <button className="bg-[#34B1D9] mt-10 lg:mt-0 text-white font-semibold py-3 px-[2px]  text-sm md:text-base rounded-lg w-44 transition-colors mx-auto flex items-center justify-center">
            Schedule a Demo
            <span className="ml-2">
              <svg
