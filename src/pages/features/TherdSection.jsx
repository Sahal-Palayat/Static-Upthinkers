...
export function FeaturesSectionDemo() {
  return (
    (<div className=" lg:py-20 h-fit">
      <div
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 md:gap-7 max-w-7xl mx-auto">
        {grid.map((feature) => (
          <div
            key={feature.title}
            className="relative bg-gradient-to-b dark:from-neutral-900 from-neutral-500 dark:to-neutral-950 to-white p-8 rounded-3xl overflow-hidden">
            <Grid size={20} />
            <p
    ...
    (<div
      ...
      <div
        ...
        <GridPattern
          ...
          y="4"
          squares={p}
          className="absolute inset-0 h-full w-full  mix-blend-overlay dark:fill-white/10 dark:stroke-white/10 stroke-white/10 fill-white/10" />
      </div>
    </div>)
  );
};
