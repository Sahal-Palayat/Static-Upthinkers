...
export const ContainerScroll = ({ titleComponent, children }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-white to-transparent  md:mb-16 z-20 h-96" />
...
export const Card = ({ rotate, scale, children }) => {
  ...
  return (
    <motion.div
      ...
      className="relative max-w-6xl   mx-auto md:h-[55rem] h-[45rem]  w-full  border-4 rounded-[30px] border-gray-900 bg-white  card-with-animated-border"
    >
      <div className="w-full h-full bg-white rounded-[30px] p-6 ">
